...
import {
  ...
  ArrowRight, Menu, X, Check, Languages, ChevronDown, ShieldCheck, Wifi,
} from 'lucide-react'
import { setLang } from '../../app/settingsSlice'
  ...
  return (
    <div className="land-page">
      ...
      <section className="land-hero land-hero--simple" id="land-main">
        ...
        <div className="land-hero-sun" aria-hidden="true" />
        <div className="land-hero-inner land-hero-inner--simple">
          ...
          <div className="land-hero-strip fade-up">
            <span><Wifi size={15} strokeWidth={1.9} /> {t.heroStripLive}</span>
            <span><Check size={15} strokeWidth={1.9} /> {t.heroStripLang}</span>
            <span><ShieldCheck size={15} strokeWidth={1.9} /> {t.heroStripSecure}</span>
          </div>
        </div>
        <ChevronDown className="land-scroll-cue" size={22} aria-hidden="true" />
      </section>
